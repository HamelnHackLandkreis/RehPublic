...
def validate_imports():
    ...
    try:
        # Test core imports
        from wildlife_processor.core.data_models import DetectionResult, AnimalDetection  # noqa: F401
        from wildlife_processor.core.models import ModelManager  # noqa: F401
        from wildlife_processor.core.processor import WildlifeProcessor  # noqa: F401
        from wildlife_processor.core.directory_scanner import DirectoryScanner  # noqa: F401

        # Test CLI imports
        from wildlife_processor.cli.main import app  # noqa: F401

        # Test utility imports
        from wildlife_processor.utils.image_utils import load_image, is_supported_format  # noqa: F401
        from wildlife_processor.utils.json_output import JSONOutputHandler  # noqa: F401
        from wildlife_processor.utils.error_handler import ErrorHandler  # noqa: F401

        # Test config imports
        from wildlife_processor.config.models_config import list_available_regions  # noqa: F401

        # Test postprocessing imports
        from wildlife_processor.postprocessing.location_enricher import LocationEnricher  # noqa: F401
...
def validate_dependencies():
    ...
    try:
        ...
        logger.warning(
            "⚠ PyTorch Wildlife not available - install with: uv add PytorchWildlife"
        )
        logger.info(
            "  This is required for actual processing but not for basic validation"
        )
