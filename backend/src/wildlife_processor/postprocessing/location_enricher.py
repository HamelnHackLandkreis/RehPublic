...
class LocationEnricher:
    ...
    def enrich_results(self, results: List[DetectionResult]) -> List[DetectionResult]:
        ...
        """
        logger.info(
            f"Enriching {len(results)} detection results with location metadata"
        )
    ...
    def lookup_camera_coordinates(
        self, camera_reference: str
    ...
    def add_camera_location(
        ...
        **additional_metadata,
        ...
        logger.info(
            f"Added location data for camera {camera_reference}: "
