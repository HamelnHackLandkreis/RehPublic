...
def process_directory(
    ...
    timeout: float = typer.Option(
        30.0,
        "--timeout", "-t",
        help="Maximum processing time per image in seconds"
    ),
    ...
    if not validate_region(model_region):
        ...
        console.print("Use 'wildlife-processor list-models' to see detailed information.")
        raise typer.Exit(1)
    ...
    try:
        console.print(f"[green]Starting wildlife camera processing...[/green]")
        ...
        for region in regions:
            ...
            try:
                ...
                if processor.model_manager.validate_models():
                    console.print(f"  [green]✓[/green] {region} models loaded successfully")
                else:
